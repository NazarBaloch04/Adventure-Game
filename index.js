    ...
    if (opponent.select == "Skeleton") {
        ...
        if (ask.opt == "Attack") {
            ...
            if (num > 0) {
                ...
                if (p1.fuel <= 0) {
                    console.log(chalk.italic.bold.blue("You Loose the Game Good Luck for Next Time"));
                    process.exit();
                }
            }
            if (num <= 0) {
        ...
        if (ask.opt == "Drink Portion") {
            p1.fuelIncrease();
            console.log(chalk.italic.bold.yellow(`You Drink Health Portion your furl is ${p1.fuel}`));
        }
